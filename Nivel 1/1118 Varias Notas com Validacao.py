...
No final deve ser impressa a mensagem
...
Se for informado o código 1 deve ser repetida a execução de todo o
programa para permitir um novo cálculo,
caso contrário o programa deve ser encerrado.

Entrada
O arquivo de entrada contém vários valores reais,
positivos ou negativos. Quando forem lidas duas notas válidas,
deve ser lido um valor inteiro X .
...
e esta mensagem deve ser apresentada novamente se o
valor da entrada padrão para X
