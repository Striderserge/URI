...
Recalcule a média (some a pontuação do exame com a
média anteriormente calculada e divida por 2). e imprima a mensagem
...
notas = []
for i in range(4):
    notas.append(float(entrada[i]))
media = (
    notas[0] * 2 + notas[1] * 3 +
    notas[2] * 4 + notas[3] * 1) / 10
