...
Escreva um programa para ler o número de gols marcados pelo Inter
e pelo Grêmio em um GRENAL. Logo após escrever a mensagem
...
a descrição apresentada acima. Obs: a palavra "Gremio" deve ser impressa sem
acento, conforme o exemplo abaixo.
'''
total, inter, gremio = 0, 0, 0
while True:
    entrada = input().split()
    ...
    if exit == 2:
        ...
        print(f'Empates:{total-inter-gremio}')
        if inter == gremio:
